export const account = [
  {
    ...
    answer:
      "A verification email will be sent to your email address when you sign up. You can also resend the verification email by clicking the 'Resend Verification Email' button on the profile page, accessible via the user menu.",
  },
  {
    question: "How do I reset my password?",
    answer:
      "Click 'Login' on the nav bar, then click 'Forgot Password?'. An email will be sent to reset your password.",
  },
